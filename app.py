...
df_master["Lam Done"] = 0
df_master["Plates Done"] = 0
...
display_df["Lam Left"] = display_df["Total Qty"] - display_df["Lam Done"]
display_df["Plates Left"] = display_df["Total Qty"] - display_df["Plates Done"]
...
edited_df["Lam Left"] = edited_df["Total Qty"] - edited_df["Lam Done"]
edited_df["Plates Left"] = edited_df["Total Qty"] - edited_df["Plates Done"]
...
with col2:
    st.metric("Print Left", f"{int(edited_df['Print Left'].sum()):,}")
with col3:
    st.metric("Lamination Left", f"{int(edited_df['Lam Left'].sum()):,}")
with col4:
    st.metric("Plates Left", f"{int(edited_df['Plates Left'].sum()):,}")
with col5:
    st.metric("Frame Left", f"{int(edited_df['Frame Left'].sum()):,}")
